...
public class PagerSecondFragment extends Fragment {
    ...
    public static PagerSecondFragment newInstance() {
        return new PagerSecondFragment();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_pager_second, container, false);
        ...
        if (prefs != null) {
            ...
            registerCategory(rootView, prefs, R.id.vl_seven, R.id.check_c7, "vl_seven");
            registerCategory(rootView, prefs, R.id.vl_eigth, R.id.check_c8, "vl_eigth");
            registerCategory(rootView, prefs, R.id.vl_nine, R.id.check_c9, "vl_nine");
            registerCategory(rootView, prefs, R.id.vl_ten, R.id.check_c10, "vl_ten");
            registerCategory(rootView, prefs, R.id.vl_eleven, R.id.check_c11, "vl_eleven");
            registerCategory(rootView, prefs, R.id.vl_twelve, R.id.check_c12, "vl_twelve");
            ...
            // Configurar setas - segunda página
    ...
    public void populateCategoryTexts(String[] categoryNames) {
        ...
        populateTextView(rootView, R.id.vl_seven, categoryNames.length > 0 ? categoryNames[0] : null);
        populateTextView(rootView, R.id.vl_eigth, categoryNames.length > 1 ? categoryNames[1] : null);
        populateTextView(rootView, R.id.vl_nine, categoryNames.length > 2 ? categoryNames[2] : null);
        populateTextView(rootView, R.id.vl_ten, categoryNames.length > 3 ? categoryNames[3] : null);
        populateTextView(rootView, R.id.vl_eleven, categoryNames.length > 4 ? categoryNames[4] : null);
        populateTextView(rootView, R.id.vl_twelve, categoryNames.length > 5 ? categoryNames[5] : null);
    }
